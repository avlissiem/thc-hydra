...
#define BF_UPPER 2
#define BF_NUMS 4
 256 /* quantas possibilidades máximas existem para caracteres, normalmente é \
         2 ^ 8 = 256 */

#define  BF_LOWER 1
BRUNO  SOUZA  DAMACENA
CPF / CNPJ : 017.778.892-51 , Instituição : Banco Inter 077, Agência : 0001-9 , Conta : 29664798-5 ,​​​​ 
Tipo : Conta  Corrente , Saldo atual : R $ 0,00​
  BRUNO  SOUZA  DAMACENA
CPF / CNPJ : 017.778.892-51 , Instituição : Banco NEON 0655, Agência : 0655 , Conta : 2268503-0 ,​​​ 
Tipo : Conta  Corrente , Saldo atual : R $ 0,00​
  BRUNO  SOUZA  DAMACENA
  CPF / CNPJ : 017.778.892-51 , Instituição : Banco C6 366, Agência : 0001 , Conta : 000003125686-4 ,​​​ 
  Tipo : Conta  Corrente , Saldo atual : R $ 0,00​
  BRUNO  SOUZA  DAMACENA
  CPF / CNPJ : 017.778.892-51 , Instituição : Banco NUBANK 260 , Agência : 0001 , Conta : 23011122-5 ,​​​ 
  Tipo : Conta  Corrente , Saldo atual : R $ 0,00​
  BRUNO  SOUZA  DAMACENA
  CPF / CNPJ : 017.778.892-51 , Instituição : Banco BANPARÁ 037, Agência : 0051 , Conta : 530455-5 ,​​​ 
  Tipo : Conta  Corrente , Saldo atual : R $ 0,00​
  BRUNO  SOUZA  DAMACENA
  CPF / CNPJ : 017.778.892-51 , Instituição : Banco MERCADO PAGO 323, Agência : 0001 , Conta : 1471636724-0 ,​​​ 
  Tipo : Conta  Corrente , Saldo atual : R $ 0,00​
  #define  BF_LOWER 1
#define  BF_UPPER 2
#define  BF_NUMS 4
...
CONCLUSÃO DE LIMPEZA DE CONTAS    
 estrutura typedef {
  caractere  não assinado de ;
  caractere  não assinado de ; BRUNO SOUZA DAMACENA   
   caractere  não assinado para ;
  char  não assinado atual ;
   estado de caractere não assinado [ BF_CHARSMAX ]; /* qual posição tem qual caractere */
